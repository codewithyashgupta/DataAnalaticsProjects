Q1: Whose is the senior most employee based on job title?
...
Q2: What are the top3 values of total invoices?
...
the most money. Write a query thatreturns one city that 
has the highest sum of invoice totals. Return both the 
...
Q7: --Let's invite the artists who have written the most rock music i
--n our dataset. Write a query that returns the Artist name and total 
...
Q10:--We want to find out the most popular music Genre for each country.We 
--determine the most popular genre as the genre with the highest amount of 
--purchases. Write a query that returns each country along with the topGenre. 
--For countries where the maximumnumber of purchases is shared return all Genres.
